...
var eventbindingsResource = schema.GroupVersionResource{Group: "samplecontroller.k8s.io", Version: "v1alpha1", Resource: "eventbindings"}

var eventbindingsKind = schema.GroupVersionKind{Group: "samplecontroller.k8s.io", Version: "v1alpha1", Kind: "EventBinding"}
...
func (c *FakeEventBindings) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.EventBinding, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(eventbindingsResource, c.ns, name, pt, data, subresources...), &v1alpha1.EventBinding{})
