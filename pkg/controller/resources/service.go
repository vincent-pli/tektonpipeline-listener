...
// MakeService generates, but does not create, a Service for the given tektonListener
func MakeService(source *samplev1alpha1.EventBinding, listenerAdapterImage string) *servingv1alpha1.Service {
	labels := map[string]string{
		"listener-adapter": "gitlab",
	}
	...
	// 	},
	// }
	// containerArgs := []string{fmt.Sprintf("--sink=%s", "helloworld")}
